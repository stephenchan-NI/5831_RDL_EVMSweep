...
#pragma warning disable CS0612
        ...
        public static void ConfigureInstrument(NIRfsg rfsgHandle, InstrumentConfiguration instrConfig, double LOPower, bool externalLO, out double LOFreq)
        {
        ...
        public static Waveform ConfigureContinuousGeneration(NIRfsg rfsgHandle, Waveform waveform, out double LOFreq, string markerEventExportTerminal = "PXI_Trig0")
        {
        ...
        public static void ApplyWaveformAttributes(NIRfsg rfsgHandle, Waveform waveform)
        {
            ...
            if (string.IsNullOrEmpty(waveform.Script)) // default to continuous if no script in waveform
                ConfigureContinuousGeneration(rfsgHandle, waveform, out loFreq);
            else
            {
                IntPtr rfsgPtr = rfsgHandle.GetInstrumentHandle().DangerousGetHandle();
        ...
        {
            rfsgHandle.FrequencyReference.Source = RfsgFrequencyReferenceSource.ReferenceIn;
        }
